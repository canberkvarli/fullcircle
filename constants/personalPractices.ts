...
const personalPractices = [
  ...
  { name: "Energy Work", category: "wellness", icon: "energy-healing", iconType: "custom" },
  ...
  { name: "Tarot", category: "insight", icon: "tarot", iconType: "custom" },
  ...
  { name: "Dance", category: "movement", icon: "dance", iconType: "custom" },
];
